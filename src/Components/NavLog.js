            ...
            <BrowserRouter>
                ...
                <div className="row">
                    <nav id="tmSidebar" className={open ? c : cc}>
                        <button className="navbar-toggler" type="button" style={{ background: 'rgba(255, 255, 255, 0.3)' }} aria-label="Toggle navigation">
                            <FontAwesomeIcon icon={faBars} className={open? showIcon : hideIcon} onClick={() => setopen(!open)} />
                            <FontAwesomeIcon icon={faTimes} className={open ? hideIcon : showIcon} onClick={() => setopen(!open)} />
                        </button>
                        ...
                        <ul id="tmMainNav" className="nav flex-column text-uppercase text-right tm-main-nav" onClick={() => setopen(!open)}>
                            ...
                            <li className="nav-item" >
                                <Link to='/login' className='nav-link active' href="#intro">
                                    <span className="d-inline-block mr-3" onClick={logout}>LogOut </span>
                                    <span className="d-inline-block tm-white-rect"></span></Link>
                            </li>
