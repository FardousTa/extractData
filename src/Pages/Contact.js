...
p3:[]
  ...
  OnSubmit = (values) => {
      console.log(values); // send the data to backend
  }
  form = (props) => {
      return <form onSubmit={props.handleSubmit} className="tm-contact-form">
          <div className="form-group">
              <Field
                  name="contact_name" id="contact_name" placeholder="Your Name"
                  className="form-control rounded-0 border-top-0 border-right-0 border-left-0"
              /><br /><div className='error'>
              <ErrorMessage  name="contact_name"   /></div>
          </div>
          <div className="form-group">
              <Field
                  name="contact_email" id="contact_email" placeholder="Your Email" type="email"
                  className="form-control rounded-0 border-top-0 border-right-0 border-left-0"
              /><br />
              <div className='error'>
              <ErrorMessage   name="contact_email" /></div>
          </div>
          <div className="form-group">
              <Field
              
                  name="contact_message" id="contact_message" placeholder="Message..." as="textarea" rows="4"
                  className="form-control rounded-0 border-top-0 border-right-0 border-left-0"
              /><br /><div className='error'>
              <ErrorMessage name="contact_message" /></div>
          </div>
    ...
    return (
      <main role="main" className="ml-sm-auto col-12">
        <div class="tm-section-wrap bg-white">
            ...
            <TextBorder title={this.state.title}  p1={this.state.p1}  p2={this.state.p2} p3={this.state.p3}/>
            <div className="col-xl-6 mb-5">
              <div className="tm-contact-form-wrap">
              <Formik
                initialValues={{ contact_name: "", contact_email: "" ,contact_message:""}}
